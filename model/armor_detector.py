...
if __name__ == "__main__":
    ...
    armor_data_path = "data/armor/armor_4844.jpg"
    armor2 = "data/armor/armor_2.jpg"
    armor3 = "data/armor/armor_3.jpg"
    armor4 = "data/armor/armor_1959.jpg"

    armor_classifier = ArmorClassifier(
        armor_params=params,
        digit_model_type=model_type,
        digit_weights_path=weights_path,
        debug=False,
    )

    # Load one image
    demo_img1 = cv2.imread(armor_data_path)
    demo_img2 = cv2.imread(armor2)
    demo_img3 = cv2.imread(armor3)
    demo_img4 = cv2.imread(armor4)
    # armor_name = armor_classifier.classify(demo_img1)
    armor_names, armor_ids = armor_classifier.classify_batch(
        [demo_img1, demo_img2, demo_img3, demo_img4]
    )
    for armor_name, armor_id in zip(armor_names, armor_ids):
        print(f"Armor ID: {armor_id}, Armor Name: {armor_name}")
