...
from model.pfa_yolov5.utils.general import LOGGER, colorstr
...
def kmean_anchors(
    ...
    Usage:
        from model.pfa_yolov5.utils.autoanchor import *; _ = kmean_anchors()
    """
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from model.pfa_yolov5.utils.dataloaders import LoadImagesAndLabels
