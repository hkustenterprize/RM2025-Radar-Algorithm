...
from model.pfa_yolov5.utils.general import LOGGER, colorstr, cv2
from model.pfa_yolov5.utils.loggers.clearml.clearml_utils import ClearmlLogger
from model.pfa_yolov5.utils.loggers.wandb.wandb_utils import WandbLogger
from model.pfa_yolov5.utils.plots import plot_images, plot_labels, plot_results
from model.pfa_yolov5.utils.torch_utils import de_parallel
...
try:
    if RANK not in [0, -1]:
        ...
        from model.pfa_yolov5.utils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from model.pfa_yolov5.utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
