...
from model.pfa_yolov5.utils import TryExcept, threaded
...
from model.pfa_yolov5.utils.metrics import fitness
from model.pfa_yolov5.utils.segment.general import scale_image
...
colors = (
    Colors()
)  # create instance for 'from model.pfa_yolov5.utils.plots import colors'
...
def plot_val_txt():  # from model.pfa_yolov5.utils.plots import *; plot_val()
...
def plot_targets_txt():  # from model.pfa_yolov5.utils.plots import *; plot_targets_txt()
...
def plot_val_study(
    file="", dir="", x=None
):  # from model.pfa_yolov5.utils.plots import *; plot_val_study()
...
def imshow_cls(
    ...
    from model.pfa_yolov5.utils.augmentations import denormalize
...
):  # from model.pfa_yolov5.utils.plots import *; plot_evolve()
...
def plot_results(file="path/to/results.csv", dir=""):
    # Plot training results.csv. Usage: from model.pfa_yolov5.utils.plots import *; plot_results('path/to/results.csv')
    save_dir = Path(file).parent if file else Path(dir)
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=""):
    # Plot iDetection '*.txt' per-image logs. from model.pfa_yolov5.utils.plots import *; profile_idetection()
